...
`ProductManagementTest` validates product management functionality through the gateway service. Tests authenticate as TENANT_ADMIN and verify product CRUD operations, barcode
validation, CSV upload, pagination, and tenant-scoped access control.
