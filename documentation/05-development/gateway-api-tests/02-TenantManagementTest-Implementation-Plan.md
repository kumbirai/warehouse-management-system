...
## Overview
`TenantManagementTest` validates all tenant management functionality through the gateway service. Tests authenticate as SYSTEM_ADMIN and verify tenant CRUD operations, lifecycle management (activate, deactivate, suspend), and multi-tenant isolation.
