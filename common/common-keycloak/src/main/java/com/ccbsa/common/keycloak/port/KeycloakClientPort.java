 ...
 * Provides base Keycloak client access for administrative operations.
 * <p>
 * This port is implemented by the KeycloakClientAdapter in the common-keycloak module
 * and used by service-specific adapters (KeycloakUserPort, KeycloakRealmPort, etc.).
 */
public interface KeycloakClientPort {
    /**
     * Gets the Keycloak admin client instance.
     * The client is configured with admin credentials and can be used
     * to perform administrative operations on Keycloak.
     *
