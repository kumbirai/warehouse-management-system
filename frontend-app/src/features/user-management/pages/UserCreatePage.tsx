                ...
                <Container maxWidth="md" sx={{py: 4}}>
                    ...
                    <Stack spacing={2} mb={3}>
                        ...
                        <Typography variant="body1" color="text.secondary">
                            Create a new user account. The user will be created in Keycloak with the specified tenant and roles.
                        </Typography>
                    </Stack>
                    ...
                    <UserForm onSubmit={handleSubmit} onCancel={() => navigate('/admin/users')} isSubmitting={isLoading}/>
                </Container>
