            ...
            <Container maxWidth="lg">
                ...
                >
                    ...
                    <Typography variant="body1" color="text.secondary" sx={{mt: 3, mb: 4, maxWidth: 600}}>
                        ...
                        Manage stock, track locations, optimize picking, and ensure seamless reconciliation.
                    </Typography>
                        ...
                        <Grid item xs={12} md={4}>
                            <Paper elevation={2} sx={{p: 3, height: '100%'}}>
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    Track consignments, monitor stock levels, and manage expiration dates with FEFO compliance.
                                </Typography>
                            </Paper>
                        </Grid>
                        <Grid item xs={12} md={4}>
