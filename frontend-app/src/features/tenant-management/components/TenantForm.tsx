...
const tenantSchema = z.object({
    tenantId: z
            ...
            .regex(/^[a-zA-Z0-9-_]+$/, 'Only alphanumeric characters, hyphens, and underscores are allowed'),
    name: z
            .string()
    ...
    phone: z
            .union([
                z.string().max(50, 'Phone cannot exceed 50 characters'),
                z.literal(''),
            ])
            .optional(),
    address: z
            .union([
                z.string().max(500, 'Address cannot exceed 500 characters'),
                z.literal(''),
            ])
            .optional(),
