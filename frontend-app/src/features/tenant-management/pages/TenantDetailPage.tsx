import {Alert, Box, Breadcrumbs, Button, CircularProgress, Container, Link, Stack, Typography,} from '@mui/material';
                            ...
                            <Stack spacing={3}>
                                <Stack direction={{xs: 'column', md: 'row'}} justifyContent="space-between" alignItems="flex-start">
                                    ...
                                    <Stack direction={{xs: 'column', sm: 'row'}} spacing={1}>
                                        <TenantActions tenantId={tenant.tenantId} status={tenant.status} onCompleted={refetch}/>
