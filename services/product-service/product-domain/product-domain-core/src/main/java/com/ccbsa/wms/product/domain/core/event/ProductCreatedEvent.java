 ...
 * Event Version: 1.0
 */
public final class ProductCreatedEvent extends ProductEvent {
    ...
    /**
     * Constructor for ProductCreatedEvent without metadata.
     *
     ...
     */
    public ProductCreatedEvent(ProductId productId, TenantId tenantId, ProductCode productCode, String description, ProductBarcode primaryBarcode,
    ...
    /**
     * Constructor for ProductCreatedEvent with metadata.
     *
     * @param productId         Product identifier
     * @param tenantId          Tenant identifier
     * @param productCode       Product code
