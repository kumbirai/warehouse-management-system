...
public final class ProductQueryResult {
    ...
    public ProductQueryResult(ProductId productId, ProductCode productCode, String description, ProductBarcode primaryBarcode, List<ProductBarcode> secondaryBarcodes,
