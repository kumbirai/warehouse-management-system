package com.ccbsa.wms.locationmanagement.messaging.listener;
 ...
 * <p>
 * Listens to TenantSchemaCreatedEvent and creates tenant schema with tables in location-management database.
 * <p>
 * This listener implements schema-per-tenant pattern by: 1. Creating the tenant schema in location-management database 2. Running Flyway migrations in the tenant schema to create
 * tables and indexes
 * <p>
