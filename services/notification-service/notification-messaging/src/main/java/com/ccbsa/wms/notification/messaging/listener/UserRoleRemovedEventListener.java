    ...
    public void handle(
        ...
        try {
            ...
            if (!isUserRoleRemovedEvent(detectedEventType)) {
                logger.debug("Skipping event - not UserRoleRemovedEvent: detectedType={}, headerType={}", detectedEventType, eventType);
            ...
            try {
                ...
                logger.info("Created role removal notification for user: userId={}, email={}, role={}", aggregateId, recipientEmail.getValue(), roleName);
            ...
            logger.error("Invalid event format for UserRoleRemovedEvent: eventData={}, error={}", eventData, e.getMessage(), e);
            acknowledgment.acknowledge();
        } catch (Exception e) {
            logger.error("Failed to process UserRoleRemovedEvent: eventData={}, error={}", eventData, e.getMessage(), e);
