...
public class TenantSuspendedEventListener {
    private static final Logger logger = LoggerFactory.getLogger(TenantSuspendedEventListener.class);
            ...
            try {
                ...
                CreateNotificationCommand command =
                        CreateNotificationCommand.builder().tenantId(tenantId).recipientUserId(UserId.of(tenantId.getValue())).recipientEmail(tenantEmail)
                                .title(Title.of("Tenant Suspended"))
    ...
    private String detectEventType(Map<String, Object> eventData, String headerType) {
        ...
        if ("Tenant".equals(aggregateType)) {
            ...
            logger.debug("No @class or header found, defaulting to TenantSuspendedEvent for aggregateType=Tenant");
