        ...
        try {
            ...
            try {
                ...
                CreateNotificationCommand command = CreateNotificationCommand.builder()
                        ...
                        .title(Title.of("Role Assigned"))
                        .message(Message.of(String.format("The role '%s' has been assigned to your account.", roleName)))
                        .type(NotificationType.USER_ROLE_ASSIGNED)
                        .build();
