 ...
 * <p>
 * Listens to UserDeactivatedEvent and creates account deactivation notification.
 * <p>
...
public class UserDeactivatedEventListener {
    ...
    private String detectEventType(Map<String, Object> eventData, String headerType) {
        ...
        // Check for UserDeactivatedEvent-specific fields (has deactivatedAt)
        if (eventData.containsKey("deactivatedAt")) {
    ...
    /**
     * Checks if the event is a UserDeactivatedEvent.
     */
    private boolean isUserDeactivatedEvent(String eventType) {
        return eventType != null && eventType.contains("UserDeactivatedEvent");
    }
