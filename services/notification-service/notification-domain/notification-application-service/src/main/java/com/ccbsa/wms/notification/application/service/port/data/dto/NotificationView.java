package com.ccbsa.wms.notification.application.service.port.data.dto;
...
/**
 * Read Model DTO: NotificationView
 * <p>
 * Optimized read model representation of Notification aggregate for query operations.
 * <p>
 * This is a denormalized view optimized for read queries, separate from the write model (Notification aggregate).
 */
public final class NotificationView {
    ...
    private NotificationView(Builder builder) {
