...
public enum NotificationStatus {
    PENDING("Notification is pending delivery"), SENT("Notification has been sent"), DELIVERED("Notification has been delivered"), FAILED("Notification delivery failed"),
