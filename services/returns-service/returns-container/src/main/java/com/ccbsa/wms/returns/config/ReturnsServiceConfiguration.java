package com.ccbsa.wms.returns.config;
...
public class ReturnsServiceConfiguration {
    ...
    /**
     * RestTemplate bean for external service calls (e.g., Picking Service).
     * <p>
     * Configured with @LoadBalanced to enable Eureka service discovery. Uses service names
     * (e.g., http://picking-service) which are resolved via Eureka registry.
     * <p>
