...
public class GetStockItemsByClassificationQueryHandler {
    ...
    public List<GetStockItemQueryResult> handle(GetStockItemsByClassificationQuery query) {
        log.debug("Handling GetStockItemsByClassificationQuery for classification: {}, tenant: {}", query.getClassification(), query.getTenantId().getValue());
        ...
        log.debug("Found {} stock item view(s) for classification: {}", stockItemViews.size(), query.getClassification());
