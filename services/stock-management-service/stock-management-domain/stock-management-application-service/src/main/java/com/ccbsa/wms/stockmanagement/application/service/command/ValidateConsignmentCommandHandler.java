...
public class ValidateConsignmentCommandHandler {
    ...
    public ValidateConsignmentCommandHandler(
    ...
    public ValidateConsignmentResult handle(ValidateConsignmentCommand command) {
        ...
        if (repository.existsByConsignmentReferenceAndTenantId(
                ...
                command.getTenantId())) {
            errors.add(String.format("Consignment reference '%s' already exists",
     ...
     */
    private void validateLineItems(List<ConsignmentLineItem> lineItems,
