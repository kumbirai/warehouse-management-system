package com.ccbsa.wms.stockmanagement.application.dto.mapper;
...
import com.ccbsa.wms.stockmanagement.application.dto.query.ConsignmentQueryDTO;
import com.ccbsa.wms.stockmanagement.application.service.command.dto.ConsignmentCsvError;
...
public class StockConsignmentDTOMapper {
    ...
    public UploadConsignmentCsvResultDTO toUploadCsvResultDTO(UploadConsignmentCsvResult result) {
        ...
        List<UploadConsignmentCsvResultDTO.ConsignmentCsvErrorDTO> errorDTOs = result.getErrors().stream()
    ...
    public ConsignmentQueryDTO toQueryResultDTO(ConsignmentQueryResult result) {
        ...
        // Map line items
        List<ConsignmentQueryDTO.ConsignmentLineItemDTO> lineItemDTOs = result.getLineItems().stream()
                .map(item -> {
