...
public interface UserJpaRepository extends JpaRepository<UserEntity, String> {
     ...
     */
    Optional<UserEntity> findByTenantIdAndUserId(String tenantId,
                                                 String userId);
     ...
     * @return User if found, empty otherwise
     */
    Optional<UserEntity> findByTenantIdAndUsername(String tenantId,
                                                   String username);
     ...
     */
    List<UserEntity> findByTenantIdAndStatus(String tenantId,
     ...
     */
    boolean existsByTenantIdAndUserId(String tenantId,
                                      String userId);
