 ...
 * Checks if Keycloak server is reachable and responsive.
 */
@Component
public class KeycloakHealthIndicator implements HealthIndicator {
    ...
    public KeycloakHealthIndicator(KeycloakConfig keycloakConfig,
    ...
    public Health health() {
        try {
            ...
            String realmUrl = String.format("%s/realms/%s",
                    keycloakConfig.getServerUrl(),
                    keycloakConfig.getDefaultRealm());
            restTemplate.getForEntity(realmUrl,
                    String.class);

            Map<String, Object> details = new HashMap<>();
            details.put("serverUrl",
                    keycloakConfig.getServerUrl());
            details.put("defaultRealm",
                    keycloakConfig.getDefaultRealm());
            details.put("status",
                    "UP");
            ...
            logger.warn("Keycloak health check failed: {}",
                    e.getMessage());
