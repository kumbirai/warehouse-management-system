 ...
 * Imports cache configuration for Redis caching support.
 */
@Configuration
@Import( {ServiceSecurityConfig.class, KafkaConfig.class, TenantCacheConfiguration.class})
public class TenantServiceConfiguration {
    ...
    public ConsumerFactory<String, Object> externalEventConsumerFactory(@Qualifier("kafkaObjectMapper") ObjectMapper kafkaObjectMapper) {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "tenant-service");
