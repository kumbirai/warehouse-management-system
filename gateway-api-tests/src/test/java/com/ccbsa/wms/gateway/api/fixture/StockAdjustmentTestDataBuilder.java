...
public class StockAdjustmentTestDataBuilder {
     ...
     */
    public static CreateStockAdjustmentRequest buildIncreaseStockRequest(
            UUID productId,
            UUID locationId,
            Integer quantity,
            String reason) {
     ...
     */
    public static CreateStockAdjustmentRequest buildDecreaseStockRequest(
            UUID productId,
            UUID locationId,
            Integer quantity,
            String reason) {
     ...
     */
    public static CreateStockAdjustmentRequest buildCorrectionStockRequest(
            UUID productId,
            UUID locationId,
            Integer quantity,
            String reason) {
     ...
     */
    public static CreateStockAdjustmentRequest buildLargeAdjustmentRequest(
            UUID productId,
            UUID locationId,
            Integer quantity,
            String reason,
        ...
        return CreateStockAdjustmentRequest.builder()
                ...
                .quantity(quantity)
                .reason(reason)
                .notes("Large adjustment requiring authorization")
